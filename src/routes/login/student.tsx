    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8 fade-in-up">
          ...
          <h1 className="text-3xl font-heading font-bold gradient-text mt-4">Student Login</h1>
        </div>
        <GlassCard className="fade-in-up-delay-1">
          <div className="space-y-4">
            <div>
              <Label>USN or Email</Label>
              <Input value={identifier} onChange={e => setIdentifier(e.target.value)} placeholder="Enter USN or Email" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck={false} className="mt-1 bg-secondary/50 border-border/50" />
            </div>
            <div>
          ...
          <div className="text-right mt-3">
            <Link to="/forgot-password" search={{ role: 'student' }} className="text-xs text-primary hover:underline">Forgot password?</Link>
          </div>
